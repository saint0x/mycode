...
try {
  ...
  execSync('esbuild src/cli.ts --bundle --platform=node --outfile=dist/cli.js --external:better-sqlite3 --external:hono --external:@hono/node-server --external:@opentui/core --external:@opentui/solid --external:solid-js', { stdio: 'inherit' });
